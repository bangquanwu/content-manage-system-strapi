...
import { pxToRem, useGuidedTour, useTracking, usePersistentState, useAppInfo, getFetchClient, auth, useRBACProvider, useStrapiApp, hasPermissions, LoadingIndicatorPage, useFetchClient, AppInfoProvider } from "@strapi/helper-plugin";
import { useQueries } from "react-query";
import lt from "semver/functions/lt";
import valid from "semver/functions/valid";
import { u as useConfiguration, s as selectAdminPermissions, a as useTypedDispatch, b as useTypedSelector, A as ACTION_SET_APP_RUNTIME_STATUS, c as createRoute, R as RBACProvider } from "./index-5878762d.mjs";
import produce from "immer";
import set from "lodash/set";
import { DndProvider } from "react-dnd";
import { HTML5Backend } from "react-dnd-html5-backend";
import { NavLink, useLocation, useHistory, Switch, Route } from "react-router-dom";
      ...
      userLinksVisible && /* @__PURE__ */ jsx(
        LinkUserWrapper,
        {
          ...
          children: /* @__PURE__ */ jsx(FocusTrap, { onEscape: handleToggleUserLinks, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 0, children: [
            ...
            /* @__PURE__ */ jsxs(LinkUser, { tabIndex: 0, onClick: handleLogout, to: "/auth/login", children: [
...
const CM = React.lazy(
  () => import("./index-5878762d.mjs").then((n) => n.x).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-f93c2bd8.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-83c6395e.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-5024deb7.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-5878762d.mjs").then((n) => n.N).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
const InternalErrorPage = React.lazy(
  () => import("./InternalErrorPage-040dc993.mjs").then(({ InternalErrorPage: InternalErrorPage2 }) => ({
    default: InternalErrorPage2
  }))
);
const ProfilePage = React.lazy(
  () => import("./ProfilePage-e397078e.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-3e25ffea.mjs").then((mod) => ({
...
const AuthenticatedApp = () => {
  ...
  return /* @__PURE__ */ jsx(
    AppInfoProvider,
    {
      ...
      shouldUpdateStrapi,
      userDisplayName,
      children: /* @__PURE__ */ jsx(RBACProvider, { permissions: permissions ?? [], refetchPermissions: refetch, children: /* @__PURE__ */ jsx(PluginsInitializer, {}) })
    }
  );
};
...
//# sourceMappingURL=AuthenticatedApp-ddb4032d.mjs.map
