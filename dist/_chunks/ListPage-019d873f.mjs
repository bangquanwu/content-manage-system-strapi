...
import { i as useEnterprise, s as selectAdminPermissions, f as useAdminUsers } from "./index-5878762d.mjs";
...
import { M as MagicLinkCE, S as SelectRoles } from "./SelectRoles-042a8887.mjs";
import { g as getFullName } from "./AuthenticatedApp-ddb4032d.mjs";
...
const ModalForm = ({ onSuccess, onToggle }) => {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import("./MagicLinkEE-92f716b9.mjs")).MagicLinkEE
  );
...
const ListPage = () => {
  const UsersListPage = useEnterprise(
    ...
    async () => (
      ...
      (await import("./ListPage-f2f022cd.mjs")).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
//# sourceMappingURL=ListPage-019d873f.mjs.map
