...
import { u as useConfiguration, s as selectAdminPermissions, a as useTypedDispatch, b as useTypedSelector, A as ACTION_SET_APP_RUNTIME_STATUS, c as createRoute, R as RBACProvider } from "./index-90ba4fba.mjs";
...
const CM = React.lazy(
  () => import("./index-90ba4fba.mjs").then((n) => n.x).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-f50fe8ab.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-b75a4303.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-76235b44.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-90ba4fba.mjs").then((n) => n.N).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-1763fd9c.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-2a690884.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-4fe5a7bd.mjs.map
