...
const assertValidLifespan$1 = (lifespan) => {
  ...
  if (!Object.values(constants$3.API_TOKEN_LIFESPANS).includes(lifespan)) {
...
const assertValidLifespan = ({ lifespan }) => {
  ...
  if (!Object.values(constants$3.TRANSFER_TOKEN_LIFESPANS).includes(lifespan)) {
