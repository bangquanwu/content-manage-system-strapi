...
const localePermissionMiddleware = () => () => (next) => (action) => {
  ...
  const containerName = get__default.default(action, "__meta__.containerName", null);
  if (!["editView", "listView"].includes(containerName)) {
    return next(action);
  }
  const locale = get__default.default(action, "__meta__.plugins.i18n.locale", null);
  if (!locale) {
    return next(action);
  }
...
const index = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await Promise.resolve().then(() => require("./SettingsPage-97924b69.js"));
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/de.json": () => Promise.resolve().then(() => require("./de-67d1d036.js")), "./translations/dk.json": () => Promise.resolve().then(() => require("./dk-1da5127a.js")), "./translations/en.json": () => Promise.resolve().then(() => require("./en-0b9b2afa.js")), "./translations/es.json": () => Promise.resolve().then(() => require("./es-779d0752.js")), "./translations/fr.json": () => Promise.resolve().then(() => require("./fr-f0ed9cfe.js")), "./translations/ko.json": () => Promise.resolve().then(() => require("./ko-5312dbfc.js")), "./translations/pl.json": () => Promise.resolve().then(() => require("./pl-f3135bb4.js")), "./translations/ru.json": () => Promise.resolve().then(() => require("./ru-31eda400.js")), "./translations/tr.json": () => Promise.resolve().then(() => require("./tr-47649759.js")), "./translations/zh-Hans.json": () => Promise.resolve().then(() => require("./zh-Hans-e3c406c2.js")), "./translations/zh.json": () => Promise.resolve().then(() => require("./zh-513f655c.js")) }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-7231f740.js.map
