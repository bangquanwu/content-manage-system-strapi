...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-55b186ce.mjs")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-5672ffd1.mjs")).FORMS,
    {
...
const AuthenticatedApp = React.lazy(
  () => import("./AuthenticatedApp-ddb4032d.mjs").then((n) => n.A).then((mod) => ({ default: mod.AuthenticatedApp }))
);
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await import("./InformationBoxEE-ad3ccede.mjs")).InformationBoxEE
  );
  useOnce(() => {
...
function ListView({ canCreate, canDelete, canRead, canPublish, layout, slug }) {
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await import("./constants-c6e4061c.mjs")).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await import("./index-95a947c1.mjs");
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await import("./constants-f31e4289.mjs")).REVIEW_WORKFLOW_FILTERS,
    {
...
//# sourceMappingURL=index-5878762d.mjs.map
