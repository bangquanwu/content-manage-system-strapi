...
declare const _default: {
    ...
    user: {
        ...
        findOne: (id: import("@strapi/types/dist/types/core/entity").ID, populate?: string[]) => Promise<import("@strapi/types/dist/types/core/attributes").GetValues<"admin::user", string> | null>;
